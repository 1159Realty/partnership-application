...
export interface IPropertyVariantFilters {
  propertyId?: string;
  userId?: string;
  stateId?: string;
  lgaId?: string;
...
interface Props {
  states: IState[] | null;
  setFilters: SetState<IPropertyVariantFilters>;
  filters: IPropertyVariantFilters;
  setQuery: SetState<string>;
  query: string;
  showPropertyFilter?: boolean;
}

const PropertyVariantFilters = ({
  states,
  setFilters,
  filters,
  ...
  function handleChange(field: keyof IPropertyVariantFilters, value: unknown) {
  ...
  const handleFilter = () => {
    const payload: IPropertyVariantFilters = {
      ...localFilters,
