...
function createDocumentTableData(name: string, description: string, client: string): DocumentTableData {
...
function ClientDocumentTable({ data, page, limit, onLimitChange, onPageChange }: DocumentTableProps) {
  const router = useRouter();

  const rows = data?.items?.map((x) => createDocumentTableData(x?.title, x?.description, getUserName(x?.client))) || [];
