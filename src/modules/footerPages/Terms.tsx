...
function Terms() {
  return (
    <Layout>
    <PrivacyWrapper>
      <MobileH3SM>TERMS OF USE</MobileH3SM>
      <br />
      <br />
      <ContentDescription>Last updated: March 20, 2025</ContentDescription>
      <ContentDescription>Please read these terms and conditions carefully before using Our Service.</ContentDescription>
      <br />
      ...
      <ContentDescription>For the purposes of these Terms and Conditions:</ContentDescription>
      <ContentDescription>
        <ListItem>
          <Span>Application</Span> means the software program provided by the Company downloaded by You on any electronic device,
          named 1159realty web app
        </ListItem>
        <ListItem>
          <Span>Application Store</Span> means the digital distribution service operated and developed by Apple Inc. (Apple App
        ...
        <ListItem>
          <Span>Company</Span> y (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to 1159realty
        ...
        <ListItem>
          <Span>Terms and Conditions</Span> s (also referred as "Terms") mean these Terms and Conditions that form the entire
        ...
        <ListItem>
          <Span>Third-party Social Media Service </Span> e means any services or content (including data, information, products or
      ...
      <MobileH1M>Acknowledgment</MobileH1M>
      <ContentDescription>
        ...
        these Terms and Conditions then You may not access the Service. <br />
      ...
      <ContentDescription>
        ...
        <br />
        We strongly advise You to read the terms and conditions and privacy policies of any thirdparty web sites or services that
        You visit.
        <br />
      </ContentDescription>
      <br />
      <MobileH1M>Termination</MobileH1M>
      <ContentDescription>
      ...
      <br />
      <MobileH1M>Limitation of Liability</MobileH1M>
      <ContentDescription>
      ...
      <br />
      <MobileH1M>"AS IS" and "AS AVAILABLE" Disclaimer</MobileH1M>
      <ContentDescription>
      ...
      <br />
      <MobileH1M>Governing Law</MobileH1M>
      <ContentDescription>
      ...
      <br />
      <MobileH1M>Disputes Resolution</MobileH1M>
      <ContentDescription>
      ...
      <br />
      <MobileH1M>For European Union (EU) Users</MobileH1M>
      <ContentDescription>
      ...
      <br />
      <MobileH1M>United States Legal Compliance</MobileH1M>
      <ContentDescription>
        You represent and warrant that (i) You are not located in a country that is subject to the United States government
        embargo, or that has been designated by the United States government as a "terrorist supporting" country, and (ii) You are
        not listed on any United States government list of prohibited or restricted parties
        <br />
      </ContentDescription>
      <br />
      <MobileH1M>Severability and Waiver</MobileH1M>
      <br /> <br />
      <MobileH1M>Severability</MobileH1M>
      <ContentDescription>
      ...
      <br />
      <MobileH1M>Translation Interpretation</MobileH1M>
      <ContentDescription>
      ...
      <br />
      <MobileH1M>Changes to These Terms and Conditions</MobileH1M>
      <ContentDescription>
